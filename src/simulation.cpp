...
boundaries_t ()
: ::xml_schema::type (),
  Left_ (Left_default_value (), ::xml_schema::flags (), this),
  Right_ (Right_default_value (), ::xml_schema::flags (), this),
       ...
       ::xml_schema::flags f)
{
  ...
  if (!Left_.present ())
  {
    this->Left_.set (Left_default_value ());
  }
  ...
  if (!Bottom_.present ())
  {
    this->Bottom_.set (Bottom_default_value ());
  }

  if (!Top_.present ())
  {
    this->Top_.set (Top_default_value ());
  }
}
