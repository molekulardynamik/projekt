...
class output_t: public ::xml_schema::type
{
  ...
  // dir
  // 
  typedef ::xml_schema::string dir_type;
...
class config_t: public ::xml_schema::type
{
  ...
  // simulationFile
  // 
  typedef ::xml_schema::string simulationFile_type;
  typedef ::xsd::cxx::tree::traits< simulationFile_type, char > simulationFile_traits;
...
configSim (const ::std::string& uri,
           ::xml_schema::flags f = 0,
...
::std::auto_ptr< ::config_t >
configSim (::xercesc::InputSource& is,
           ::xml_schema::flags f = 0,
           const ::xml_schema::properties& p = ::xml_schema::properties ());
