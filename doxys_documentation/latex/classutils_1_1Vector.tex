...
\subsubsection[{Vector}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename type, int length$>$ {\bf utils\-::\-Vector}$<$ type, length $>$\-::{\bf Vector} (
...
\subsubsection[{Vector}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename type, int length$>$ {\bf utils\-::\-Vector}$<$ type, length $>$\-::{\bf Vector} (
\begin{DoxyParamCaption}
\item[{type}]{args\mbox{[}length\mbox{]}}
\end{DoxyParamCaption}
...
\subsubsection[{Vector}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename type, int length$>$ {\bf utils\-::\-Vector}$<$ type, length $>$\-::{\bf Vector} (
\begin{DoxyParamCaption}
\item[{const {\bf Vector}$<$ type, length $>$ \&}]{other}
\end{DoxyParamCaption}
...
\subsubsection[{equals}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename type, int length$>$ bool {\bf utils\-::\-Vector}$<$ type, length $>$\-::equals (
\begin{DoxyParamCaption}
\item[{const {\bf Vector}$<$ type, length $>$ \&}]{rhs}
\end{DoxyParamCaption}
...
\subsubsection[{L2\-Norm}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename type, int length$>$ double {\bf utils\-::\-Vector}$<$ type, length $>$\-::L2\-Norm (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{operator$\ast$}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename type, int length$>$ {\bf Vector} {\bf utils\-::\-Vector}$<$ type, length $>$\-::{\bf operator}$\ast$ (
\begin{DoxyParamCaption}
\item[{double}]{scalar}
\end{DoxyParamCaption}
...
\index{operator$\ast$@{operator$\ast$}!utils::Vector@{utils\-::\-Vector}}
\subsubsection[{operator$\ast$}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename type, int length$>$ type {\bf utils\-::\-Vector}$<$ type, length $>$\-::{\bf operator}$\ast$ (
\begin{DoxyParamCaption}
\item[{const {\bf Vector}$<$ type, length $>$ \&}]{rhs}
\end{DoxyParamCaption}
...
\subsubsection[{operator+}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename type, int length$>$ {\bf Vector} {\bf utils\-::\-Vector}$<$ type, length $>$\-::{\bf operator}+ (
\begin{DoxyParamCaption}
\item[{const {\bf Vector}$<$ type, length $>$ \&}]{rhs}
\end{DoxyParamCaption}
...
\index{operator==@{operator==}!utils::Vector@{utils\-::\-Vector}}
\subsubsection[{operator==}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename type, int length$>$ bool {\bf utils\-::\-Vector}$<$ type, length $>$\-::{\bf operator}== (
\begin{DoxyParamCaption}
\item[{const {\bf Vector}$<$ type, length $>$ \&}]{rhs}
\end{DoxyParamCaption}
...
\subsubsection[{operator[]}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename type, int length$>$ type\& {\bf utils\-::\-Vector}$<$ type, length $>$\-::{\bf operator}\mbox{[}$\,$\mbox{]} (
\begin{DoxyParamCaption}
\item[{int}]{i}
\end{DoxyParamCaption}
...
\index{operator\mbox{[}$\,$\mbox{]}@{operator[]}!utils::Vector@{utils\-::\-Vector}}
\subsubsection[{operator[]}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename type, int length$>$ const type\& {\bf utils\-::\-Vector}$<$ type, length $>$\-::{\bf operator}\mbox{[}$\,$\mbox{]} (
\begin{DoxyParamCaption}
\item[{int}]{i}
\end{DoxyParamCaption}
...
\subsubsection[{to\-String}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename type, int length$>$ std\-::string {\bf utils\-::\-Vector}$<$ type, length $>$\-::to\-String (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\item[{const {\bf Vector}$<$ type, length $>$ \&}]{v}
\end{DoxyParamCaption}
...
\subsubsection[{content}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename type, int length$>$ type {\bf utils\-::\-Vector}$<$ type, length $>$\-::content\mbox{[}length\mbox{]}\hspace{0.3cm}{\ttfamily [private]}}}\label{classutils_1_1Vector_ab391d67eb8f8563b4dd4b80390a4631a}
